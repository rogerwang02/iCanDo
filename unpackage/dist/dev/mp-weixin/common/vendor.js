...
function initRuntimeSocketService() {
  const hosts = "127.0.0.1,192.168.3.81";
  const port = "8090";
  const id = "mp-weixin_6y-pGM";
...
const S = true, b = "mp-weixin", T = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = b, P = I('{"address":["127.0.0.1","192.168.3.81"],"servePort":7003,"debugPort":9002,"initialLaunchType":"local","skipFiles":["<node_internals>/**","/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"]}'), C = I('[{"provider":"tencent","spaceName":"roger-server1","spaceId":"tcb-hn8ynjkzdpimzki-4cq0cacf172f"}]') || [];
let O = "";
try {
  O = "__UNI__2F61D10";
} catch (e2) {
